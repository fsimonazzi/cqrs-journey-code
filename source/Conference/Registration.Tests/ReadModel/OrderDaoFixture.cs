...
namespace Registration.Tests.ReadModel
{
    ...
    public class OrderDaoFixture
    {
        ...
        public void when_finding_non_existing_assignment_then_returns_null()
        {
            ...
            var dao = new OrderDao(() => new ConferenceRegistrationDraftOrdersDbContext("OrderDaoFixture"), () => new ConferenceRegistrationPricedOrdersDbContext("OrderDaoFixture"), storage.Object, Mock.Of<ITextSerializer>());
        ...
        public void when_finding_existing_dao_then_deserializes_blob_and_returns_instance()
        {
            ...
            var dao = new OrderDao(() => new ConferenceRegistrationDraftOrdersDbContext("OrderDaoFixture"), () => new ConferenceRegistrationPricedOrdersDbContext("OrderDaoFixture"), storage, serializer);
